    ...
    return (
        <div className="text-white ">
            ...
            <section className="py-10">
                <h2 className="text-3xl text-center font-bold mt-10">E-commerce Website Development</h2>
                <h3 className="text-2xl text-center font-semibold mt-5">Web Developer</h3>
                <p className="mx-60 mt-10">
            ...
            <section className="py-10">
                ...
                <h3 className="text-2xl text-center font-semibold mt-5">ML Engineer</h3>
                <p className="mx-60 mt-10">
            ...
            <section className="py-10">
                <h2 className="text-3xl text-center font-bold mt-10">Elevate Discernable Over Formation Retardant in Neural Network</h2>
                <h3 className="text-2xl text-center font-semibold mt-5">DL Engineer, Full-stack Developer</h3>
                <p className="mx-60 mt-10">
            ...
            <section className="py-10">
                <h2 className="text-3xl text-center font-bold mt-10">Solar Marketplace Website</h2>
                <h3 className="text-2xl text-center font-semibold mt-5">Full-stack Developer</h3>
                <p className="mx-60 mt-10">
