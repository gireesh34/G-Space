...
const Exp: React.FC = () => {
    return (
        <div className="text-white "
          id="exp"
        >
            <header className="text-[40px] md:text-[50px] text-center font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 py-20">
                <h1>Experience</h1>
            </header>
            <section className="py-10">
                <h2 className="text-2xl md:text-3xl text-center font-bold mt-10">E-commerce Website Development</h2>
                <h3 className="text-xl md:text-2xl text-center font-semibold mt-5">Web Developer</h3>
                <p className="mx-4 md:mx-60 mt-10">
                    Developed and maintained a fully functional e-commerce website using HTML, CSS, and SQL to manage the product database.
                </p>
                <p className="mx-4 md:mx-60 mt-5">
            ...
            <section className="py-10">
                <h2 className="text-2xl md:text-3xl text-center font-bold mt-10">Automated Face Recognition Attendance System</h2>
                <h3 className="text-xl md:text-2xl text-center font-semibold mt-5">ML Engineer</h3>
                <p className="mx-4 md:mx-60 mt-10">
            ...
            <section className="py-10">
                <h2 className="text-2xl md:text-3xl text-center font-bold mt-10">Elevate Discernable Over Formation Retardant in Neural Network</h2>
                <h3 className="text-xl md:text-2xl text-center font-semibold mt-5">DL Engineer, Full-stack Developer</h3>
                <p className="mx-4 md:mx-60 mt-10">
            ...
            <section className="py-10">
                <h2 className="text-2xl md:text-3xl text-center font-bold mt-10">Solar Marketplace Website</h2>
                <h3 className="text-xl md:text-2xl text-center font-semibold mt-5">Full-stack Developer</h3>
                <p className="mx-4 md:mx-60 mt-10">
